...
<div>
<a href="../deliverystation/add.do"><input type="button" class="t_add" value="注册无人机" ></a>
<a href="../deliverystation/orderUAVSchedule.do"><input type="button" class="t_add" value="订单预调度" ></a>
</div>
<div>
