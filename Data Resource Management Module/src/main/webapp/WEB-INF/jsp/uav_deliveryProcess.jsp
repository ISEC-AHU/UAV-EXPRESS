...
<div  height="290px">
UAV【${uav_id}】 starts to delivery carrying with the package【${order_id}】 
</div>
</div>
...
<div  height="290px">
UAV【${uav_id}】 arrives at 【${currentLoc}】 carrying with the package【${order_id}】
<c:if test="${deliveryState=='waiting for pickup'}">
<form action="../uav/uploadImage.do?order_id=${order_id}&currentLoc=${currentLoc}" method="post"  enctype="multipart/form-data">
Upload the receipt of goods: <input type="file" name="image" /><button>upload</button>
</form>
